	...
	<form method="post" action="cad-apresentacao.php">
		...
		<div class="row">
            ...
            <label for="tema">* Digite o titulo da apresentação:</label>
				<input type="text" class="form-control" name="txttitulo" required="true" 
                <?php if (!$cd_titulo == null) { echo "value='". $cd_titulo ."'";}; ?>>
			</div>
		</div>
		...
		<div class="row">
            ...
            <label for="semestre">* Resumo da apresentação:</label>
				<input type="text" class="form-control" name="txtresumo" required="true" 
                <?php if (!$cd_resumo == null) { echo "value='". $cd_resumo ."'";}; ?>>
			</div>
			<div class="col-sm-6">
            <label for="semestre">* Data da apresentação:</label>
				<input type="date" class="form-control" name="txtdata" required="true" 
                <?php if (!$cd_data == null) { echo "value='". $cd_data ."'";}; ?>>
			</div>
		</div>
		...
		<div class="row">
            ...
            <label>Alunos</label><br/>
				<select required="true" class="form-control" name="alunos_id">
